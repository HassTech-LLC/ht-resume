...
const styles = StyleSheet.create({
  ...
  name: { fontSize: 22, fontFamily: 'Helvetica-Bold', color: PALETTE.ink, marginBottom: 8, letterSpacing: 0.2, lineHeight: 1.15 },
  label: { fontSize: 10.5, color: PALETTE.violet, marginBottom: 10, fontFamily: 'Helvetica-Bold', lineHeight: 1.35 },
